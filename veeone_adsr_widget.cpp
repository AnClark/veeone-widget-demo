                                 ...
                                 uint32_t width, uint32_t height)
{
    ...
    // 绘制 attack 曲线
    //
    const int attack_width = width_1div4 * (*attack);
    ...
    const int decay_width = width_1div4 * (*decay);
    const int sustain_width = width_1div4;
    const int sustain_height = height * (*sustain);
    ...
    // 绘制 release 曲线
    //
    const int release_width = width_1div4 * (*release);
